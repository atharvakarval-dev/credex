...
export function Globe({
  ...
  arcs = [],
  className = "",
  markerColor = [0.88, 0.88, 0.80], // #E1E0CC equivalent
  baseColor = [1, 1, 1],            // Base color must be white when dark=1 for map to show
  arcColor = [0.88, 0.88, 0.80],
  glowColor = [0.2, 0.2, 0.2],      // Subtle glow
  dark = 1,                         // Dark mode enabled
  mapBrightness = 6,                // Increased brightness for visibility
  markerSize = 0.04,
      ...
      {markers.map((m) => (
        <div
          ...
          style={{
            ...
            borderRadius: "4px",
            fontWeight: "bold",
            boxShadow: "0 0 10px rgba(225, 224, 204, 0.3)"
          }}
        >
          {m.label}
          <span
